...
<details>
  ...
  Em cada requisito encontra-se informações demonstrando como a API deverá se comportar, dada a requisição específica. O não cumprimento de um requisito, total ou parcialmente, impactará em sua avaliação.
